...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  ...
  it('Teste se os parâmetros não são Case Sensitive.', () => {
    expect(getCharacter('arya') === getCharacter('Arya') || getCharacter('brienne') === getCharacter('Brienne') || getCharacter('melissandre') === getCharacter('Melissandre') ).toBeTruthy();
  });

  it('Teste se ao passar um nome que não está na tabela, a função retorna undefined.', () => {
    expect(getCharacter('Luiz')).toEqual(undefined);
  });
});
