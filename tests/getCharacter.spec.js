...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    // Teste se a função retorna o objeto correto para o parâmetro
    // 'Melissandre',
    ...
    expect(getCharacter('Arya')).not.toBe(expect(getCharacter('arya')));
    // Teste se ao passar um nome que não está na tabela, a função retorna
    // undefined.
    expect(getCharacter('Cletin')).toBeUndefined();
  });
});
