...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  ...
  it('Teste se a função retorna o objeto correto para o parâmetro "Arya".', () => {
    const outputArya = {name: 'Arya Stark', class: 'Rogue', phrases: ['Not today', 'A girl has no name.']};
    expect(getCharacter('arya')).toEqual(outputArya);
  });    

  it('Teste se a função retorna o objeto correto para o parâmetro "Brienne".', () => {
    const outputBrienne = {name: 'Brienne Tarth', class: 'Knight', phrases: ['Im No Lady, Your Grace.', 'I, Brienne Of Tarth, Sentence You To Die.']};
    expect(getCharacter('brienne')).toEqual(outputBrienne);
  });

  it('Teste se a função retorna o objeto correto para o parâmetro "Melissandre".', () => {
    const outputMelissandre = {name: 'Melissandre', class: 'Necromancer', phrases: ['Death By Fire Is The Purest Death.', 'For The Night Is Dark And Full Of Terrors.']};
    expect(getCharacter('melissandre')).toEqual(outputMelissandre);
  });
