...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    const returnObj = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} })
    returnObj.order('coxinha')
    expect(returnObj.consumption).toMatchObject(['coxinha'])
    ...
    returnObj.order('agua')
    returnObj.order('sopa')
    returnObj.order('sashimi')
    // objetoRetornado.consumption // Retorno: ["coxinha", "agua", "sopa", "sashimi"]
    expect(returnObj.consumption).toMatchObject(["coxinha", "agua", "sopa", "sashimi"])
    // ```
    ...
    returnObj.order('coxinha')
    expect(returnObj.consumption).toMatchObject(["coxinha", "agua", "sopa", "sashimi", "coxinha"])
    ...
    // ```
    const objPay = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} })
    objPay.order('coxinha');
    expect(objPay.pay()).toEqual(4.29)
    objPay.order('agua');
    expect(objPay.pay()).toEqual(8.58);
    objPay.order('coxinha');
    expect(objPay.pay()).toEqual(12.87);
