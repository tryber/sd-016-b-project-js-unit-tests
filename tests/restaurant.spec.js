...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    //  const consumptionTest = createMenu(objetoRetornado).fetchMenu();
    ...
    expect(createMenu(objetoRetornado).fetchMenu).toBeInstanceOf(Function);
    ...
    expect(createMenu(objetoRetornado).fetchMenu()).toBe(objetoRetornado);
    ...
    expect(createMenu(objetoRetornado).addConsumption()).toEqual({
      ...returnObj(),
      consumption: []
    });
    ...
    expect(orderFromMenu('coxinha')).toEqual({
      ...returnObj(),
      consumption: ['coxinha']
    });
    ...
    expect(addItemConsumption()).toEqual({
      ...returnObj(),
      consumption: ['coxinha', 'agua', 'sopa', 'cerveja']
    });
    ...
    expect(orderFromMenu('coxinha')).toEqual({
      ...returnObj(),
      consumption: ['coxinha', 'agua', 'sopa', 'cerveja', 'coxinha']
    });
    ...
    const objValueEnd = (returnObj) => {

    };
    expect(createMenu(objetoRetornado).pay()).toEqual(34.6);
