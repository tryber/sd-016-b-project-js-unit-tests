...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    let menu = createMenu();
    expect(menu).toMatchObject(/{ fetchMenu: () => {}}/);
    ...
    // ```
    let menuParametro = { food: {}, drink: {} };
    menu = createMenu(menuParametro);
    ...
    // ```
    menuParametro = { food: {}, drink: {} };
    menu = createMenu(menuParametro);
    expect(menu.fetchMenu()).toEqual(menuParametro);
    ...
    // ```
    menuParametro = { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} };
    menu = createMenu(menuParametro);
    menu.order('coxinha');
    menu.order('agua');
    menu.order('coxinha');
