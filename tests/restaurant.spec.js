...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    let myMenu = createMenu({food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9}});
    ...
    expect(myMenu.fetchMenu()).toMatchObject({food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9}})
    ...
    expect(myMenu.consumption).toEqual(['coxinha']);
    // Agora faça o PASSO 3 no arquivo `src/restaurant.js`.
    // --------------------------------------------------------------------------------------
    // TESTE 6: Verifique se, ao adicionar três pedidos, dentre bebidas e comidas, o array `objetoRetornado.consumption` contém os itens pedidos.
    myMenu = createMenu({food: {}, drink: {}});
    // ```
    // objetoRetornado.order("coxinha");
    myMenu.order('coxinha')
    ...
    expect(myMenu.consumption).toEqual(['coxinha', 'agua', 'sopa', 'sashimi']);
    // ```
    ...
    expect(myMenu.consumption).toEqual(['coxinha', 'agua', 'coxinha']);
    // ```
    ...
    myMenu = createMenu({food: {'coxinha': 5.35, 'pizza': 20.40}, drink: {'refrigerante': 3.50, 'agua': 2.75}});
    // ```
    // objetoRetornado.order('coxinha');
    myMenu.order('coxinha')
    // objetoRetornado.order('agua');
    ...
    // ```
    expect(myMenu.pay()).toEqual(13.45);
