...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  ...
  //const objetoRetornado = createMenu(); // Retorno: { fetchMenu: () => {}, ... }
    ...
    expect(createMenu(obj).fetchMenu()).toStrictEqual({ food: {}, drink: {} });
    ...
    createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9}}).order("sopa");
    // objetoRetornado.order("sashimi");
    createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9}}).order("sashimi");
    // objetoRetornado.consumption // Retorno: ["coxinha", "agua", "sopa", "sashimi"]
    expect(createMenu(obj2).consumption).toEqual(["coxinha", "agua", "sopa", "sashimi"]);
    // Agora faça o TESTE 7 deste arquivo.
    // --------------------------------------------------------------------------------------
    // TESTE 7: Verifique se a função `order` aceita que pedidos repetidos sejam acrescidos a consumption.
    // ```
    // objetoRetornado.order('coxinha');
    createMenu(obj2).order('coxinha');
    // objetoRetornado.order('agua');
    createMenu(obj2).order('agua');
    // objetoRetornado.order('coxinha');
    createMenu(obj2).order('coxinha');
    // objetoRetornado.consumption // Retorno: ['coxinha', 'agua', 'coxinha']
    expect(createMenu(obj2).consumption).toEqual(['coxinha', 'agua', 'coxinha']);
