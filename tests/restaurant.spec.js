...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    const verifyFunction = (typeof objetoRetornado.fetchMenu === 'function') ? true : false
    expect(verifyFunction).toBe(true);
    // ```
    ...
    const teste2 = Object.keys(objetoRetornado2.fetchMenu());
    expect(teste2).toEqual(['food', 'drink']); // Retorno: { food: {}, drink: {}}
    // ```
    ...
    // ```
    const objetoRetornado3 = createMenu({ food: {}, drink: {}, teste: {} });
    expect(objetoRetornado3.fetchMenu()).toEqual({ food: {}, drink: {}, teste: {} }); // Retorno: objetoQualquer
    // ```
    // Agora faça o PASSO 1 no arquivo `src/restaurant.js`.
    // --------------------------------------------------------------------------------------
    // TESTE 4: Verifique se 'objetoRetornado.consumption', após a criação do menu, retorna um array vazio.
    // ```
    const objetoRetornado4 = createMenu({ food: {}, drink: {}, teste: {} });
    ...
    // ```
    const objetoRetornado5 = createMenu({ food: {}, drink: {}, teste: {} });
    ...
    const objetoRetornado6 = createMenu({ food: {}, drink: {}, teste: {} });
    ...
    // ```
    const objetoRetornado7 = createMenu({ food: {}, drink: {}, teste: {} });
    ...
    objetoRetornado8.order('coxinha');
    expect(objetoRetornado8.pay()).toBe(12.87) // Retorno: somaDosPreçosDosPedidos
