...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    expect(createMenu({ food: {'food1': 4.0}, drink: {'drink1': 2.5} }).fetchMenu()).toMatchObject({ food: {'food1': 4.0}, drink: {'drink1': 2.5} });
    ...
    menu.order('água');
    menu.order('macarrão');
    expect(menu.consumption).toEqual(["coxinha", "água", "macarrão"]);
    ...
    menu.order('água');
    menu.order('coxinha');
    expect(menu.consumption).toEqual(["coxinha", "água", "coxinha"]);
    ...
    // ```
    menu = createMenu({ food: {'coxinha': 4.5}, drink: {'água': 2.0} });
    menu.order('coxinha');
    menu.order('água');
    menu.order('coxinha');
    expect(menu.pay()).toEqual(11);
