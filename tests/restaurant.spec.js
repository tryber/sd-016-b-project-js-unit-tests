...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(createMenu().fetchMenu).toBeInstanceOf(Function); // vi que ao usar o toHaveProperty, eu posso colocar a chave e o valor, mas ao colocar como valor esperado Function o meu retorno era 'Function fetchMenu' e não achei nenhuma outra forma a não ser fazer as validaçoes de forma independente.
    ...
    let menu = createMenu();
    menu.order('coxinha');
    expect(menu.consumption).toEqual(expect.arrayContaining(['coxinha']));
    ...
    menu.order('sopa');
    menu.order('sashimi');    
    expect(menu.consumption).toEqual(expect.arrayContaining(['coxinha', 'agua', 'sopa', 'sashimi']));
    ...
    menu.order('agua'); 
    menu.order('coxinha');      
    expect(menu.consumption).toEqual(expect.arrayContaining(['coxinha', 'agua', 'coxinha']));
