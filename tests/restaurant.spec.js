...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
    ...
    it('TESTE 2', () => {
      ...
      expect(obj.fetchMenu()).toEqual({ food: {}, drink: {} });
    });
    ...
    // --------------------------------------------------------------------------------------
    it('TESTE 3', () => {
      const obj = createMenu({food:{1:'hamburguer'}, drink: {1:'coca'}});
      expect(obj.fetchMenu()).toEqual({food:{1:'hamburguer'}, drink: {1:'coca'}});
    }); 
    ...
    it('TESTE 7', () => {
      ...
      obj.order('agua')
      obj.order('coxinha')
      expect(obj.consumption).toEqual(['coxinha', 'agua', 'coxinha']);
    });
    ...
    it('TESTE 8', () => {
      const obj = createMenu({food: {'coxinha': 3.90,'sanduiche': 9.90},drinks: {'agua': 3.90,'cerveja': 6.90},});
      obj.order('coxinha')
      obj.order('agua')
      obj.order('coxinha')
      expect(obj.pay()).toBe('12.87');
    });
});
