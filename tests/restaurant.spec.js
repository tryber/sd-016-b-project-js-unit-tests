...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    expect(createMenu(menu).fetchMenu()).toEqual({ food: {}, drink: {}});
    ...
    // --------------------------------------------------------------------------------------
    const cardapio = {comida: {}, bebida:{}};
    expect (createMenu(cardapio).fetchMenu()).toEqual({comida: {}, bebida:{}});
    ...
    teste5.order("agua");
    teste5.order("sopa");
    teste5.order("sashimi");
    expect (teste5.consumption).toEqual(["coxinha", "agua", "sopa", "sashimi"]);
    ...
    expect (teste7.pay()).toEqual(3.9*3+(3.9*3)*0.1)// 12.87);
  });
});
