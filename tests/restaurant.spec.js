...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(typeof createMenu(obj)).toBe('object');
  ...
  //const objetoRetornado = createMenu(); // Retorno: { fetchMenu: () => {}, ... }
    ...
    expect(createMenu(obj).consumption).toStrictEqual([]);
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    const required = createMenu(obj2);
    required.order('coxinha');
    expect(required.consumption).toEqual(['coxinha']);
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    const restaurant1 = createMenu(obj2);
    // objetoRetornado.order("coxinha");
    restaurant1.order("coxinha");
    // objetoRetornado.order("agua");
    restaurant1.order("agua");
    // objetoRetornado.order("sopa");
    restaurant1.order("sopa");
    // objetoRetornado.order("sashimi");
    restaurant1.order("sashimi");
    // objetoRetornado.consumption // Retorno: ["coxinha", "agua", "sopa", "sashimi"]
    expect(restaurant1.consumption).toEqual(["coxinha", "agua", "sopa", "sashimi"]);
    // Agora faça o TESTE 7 deste arquivo.
    // --------------------------------------------------------------------------------------
    // TESTE 7: Verifique se a função `order` aceita que pedidos repetidos sejam acrescidos a consumption.
    const restaurant2 = createMenu(obj2);
    // objetoRetornado.order('coxinha');
    restaurant2.order('coxinha');
    // objetoRetornado.order('agua');
    restaurant2.order('agua');
    // objetoRetornado.order('coxinha');
    restaurant2.order('coxinha');
    // objetoRetornado.consumption // Retorno: ['coxinha', 'agua', 'coxinha']
    expect(restaurant2.consumption).toEqual(['coxinha', 'agua', 'coxinha']);
    ...
    const restaurant3 = createMenu(obj2);
    // objetoRetornado.order('coxinha');
    ...
    expect(restaurant3.pay()).toBeCloseTo(12.87);
    // ```
