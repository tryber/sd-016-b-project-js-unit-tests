...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(typeof (createMenu())).toMatch('object');
    expect(Object.keys(createMenu())).toEqual(expect.arrayContaining([ 'fetchMenu' ]));
    expect(typeof (createMenu().fetchMenu)).toMatch('function')
    ...
    // ```
    expect(createMenu({ food: {}, drinkd: {} }).fetchMenu()).toEqual({ food: {}, drinkd: {} });
