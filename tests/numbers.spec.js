...
describe("2 - Implemente os casos de teste para a função `numbers`", () => {
  ...
  it("Verifica se a função `numbers` retorna `false` ao receber strings no array", () => {
    // Escreva um teste em que a função recebe [1, 2, '3', 4, 5] e retorna false
    expect(numbers([1, 2, "3", 4, 5])).toBeFalsy;
  });

  it("Verifica se a função `numbers` retorna `false` ao receber uma letra no array", () => {
    // Escreva um teste em que a função recebe [1, 'a', 3] e retorna false
    expect(numbers([1, "a", 3])).toBeFalsy;
  });

  it("Verifica se a função `numbers` retorna `false` ao receber um array vazio", () => {
