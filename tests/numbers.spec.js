...
describe('2 - Implemente os casos de teste para a função `numbers`', () => {
    ...
    it('Testa se a funcao recebe true caso o array tenha apenas numbers', () => {
      expect(numbers([1, 2, 3, 4, 5])).toBe(true);
    });
    // Escreva um teste em que a função recebe [1, 2, '3', 4, 5] e retorna false
    it('Testa se a funcao recebe false caso o array tenha itens diferentes de numeros', () => {
    ...
    it('Testa se a funcao recebe false caso o array esteja vazio', () => {
