...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
    ...
    it('Verifica se a função retorna undefined ao receber um parâmetro diferente de número', () =>{
    ...
    it('Verifica se a função retorna os dados corretos para um círculo de raio 3', () => {
