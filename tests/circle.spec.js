...
it('verifica se circle retorna um objeto.',()=>{
  expect('object').toEqual(typeof (circle(1))); 
})
it('verifica se circle retorna o objeto retornado tem 3 propriedades',()=>{
  expect(circle(1)).toEqual(circle(1)); 
})
it('verifica se a função retorna undefined,quando não recebe nenhum parâmetro',()=>{
  expect(circle()).toBeUndefined(); 
})
 it('verifica se função retorna, dentro de um objeto, a circunferência correta para um círculo de raio 2',()=>{
...
it('verifica se função retorna, num objeto, os dados corretos de um círculo de raio 3',()=>{
