...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    const testReturn = { radius: 1, area: 3.14, circumference: 6.28 };
    ...
    expect(Object.keys(circle(1)).length).toBe(Object.keys(testReturn).length);
...
// 1. https://newbedev.com/jest-how-to-test-for-object-keys-and-properties
