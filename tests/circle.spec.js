...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    // Teste se circle retorna undefined, caso o parâmetro passado não seja um
    // número.
    ...
    // Teste que a função retorna, dentro de um objeto, a circunferência correta
    // para um círculo de raio 2.
    expect(circle(2)).toHaveProperty('circumference', 12.56);
    // Teste que a função retorna, dentro de um objeto, a área correta para um
    // círculo de raio 3.
    expect(circle(3)).toHaveProperty('area', (3.14 * 3 * 3));
    // Teste que a função retorna, num objeto, os dados corretos de um círculo
    // de raio 3.
