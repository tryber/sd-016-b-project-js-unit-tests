...
const calculator = (number1, number2) => {
  ...
  return calculatingObj;
};
const arrayGenerator = (type, calculatingObj) => {
  if (type === 'keys') {
    return Object.keys(calculatingObj);
  }
  if (type === 'values') {
    return Object.values(calculatingObj);
  }
  if (type === 'entries') {
    return Object.entries(calculatingObj);
  }
};
